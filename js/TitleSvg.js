...
(function() {
    function initTitleAnimation() {
        ...
        // 用 requestAnimationFrame 确保 SVG 渲染完成后再启动动画
        // 双重 rAF 确保浏览器完成布局和绘制
